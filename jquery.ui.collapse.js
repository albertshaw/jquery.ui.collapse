...
(function ($, undefined) {
    ...
    $.widget(
        ...
        _destroyIcons : function () {
            this.headers.removeClass("ui-collapse-icons").children(".ui-collapse-header-icon").remove();
        },
        ...
        _setOption : function (key, value) {
            if (key === "active") {
                ...
                if (typeof value === 'number') {
                    ...
                    for (var i = 0; i < this.headers.length; i++) {
                        this.options.active[i] = true;
                        this._activate(i);
                    }
                } else if ($.isArray(value)) {
                    for (var i = 0; i < value.length; i++) {
                        this.options.active[value[i]] = true;
                        this._activate(value[i]);
                    }
                }
                return;
            }
            ...
            if (key === "deactive") {
                if (typeof value === 'number') {
                    ...
                    for (var i = 0; i < this.headers.length; i++) {
                        this.options.active[i] = false;
                        this._deactivate(i);
                    }
                } else if ($.isArray(value)) {
                    for (var i = 0; i < value.length; i++) {
                        this.options.active[value[i]] = false;
                        this._deactivate(value[i]);
                    }
                }
                return;
            }
        ...
        _refresh : function () {
            ...
            parent = this.element
                .parent(),
            collapseId = this.collapseId = "ui-collapse-"
        ...
        _eventHandler : function (event) {
            ...
            if (clickedIsActive) {
                ...
                if (options.icons) {
                    clicked.children(".ui-collapse-header-icon")
                    .removeClass(options.icons.activeHeader).addClass(options.icons.header);
                }
